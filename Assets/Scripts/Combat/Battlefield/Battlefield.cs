...
namespace Scorewarrior.Test.Models
{
    public sealed class Battlefield : IBattlefield
    {
        ...
        readonly Dictionary<Team, List<ICharacter>> _charactersByTeam = new(4);
        ...
        public ICharacter[] GetCharactersOfTeam(Team team)
            => _charactersByTeam[team].ToArray();

        public bool TeamIsAlive(Team team)
            => _charactersByTeam[team].Any(chr => chr.IsAlive);
        
        public bool TeamIsDead(Team team)
